...
struct Samochod{
    ...
    ~Samochod(){
        ...
        if(silnik->moc_m!=nullptr){
            delete silnik->moc_m;
            silnik->moc_m=nullptr;
        }
        if(silnik->zuzycie_paliwa_m!=nullptr){
            delete silnik->zuzycie_paliwa_m;
            silnik->zuzycie_paliwa_m=nullptr;
        }
        if(silnik!=nullptr) {
            delete silnik;
            silnik = nullptr;
        }
        //samochod usuwa sie bez koniecznosci osobnego usuwania dla silnika
